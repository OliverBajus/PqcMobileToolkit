...
import com.example.pqcdemoapp.domain.model.PqcFailure
...
class BcPqcRepository @Inject constructor(
    ...
    override suspend fun runSigFlow(
        ...
        val bcSig = BcSig.fromId(alg.id) ?: return Either.Left(PqcFailure.PqcError(null, "Unsupported BC Sig choice: ${alg.id}"))
        ...
        val signer = sigManager.signerFactory(true, ParametersWithRandom(keyPair.private, secureRandom))
