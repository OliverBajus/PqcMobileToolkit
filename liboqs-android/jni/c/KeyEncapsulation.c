 ...
 */
JNIEXPORT void JNICALL Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_create_1KEM_1new
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_free_1KEM
 ...
 */
JNIEXPORT jobject JNICALL Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_get_1KEM_1details
  (JNIEnv *env, jobject obj)
{
    jclass cls = (*env)->FindClass(env, "io/github/oliverbajus/liboqs_android/kem/KeyEncapsulation$KeyEncapsulationDetails");
 ...
 * Signature: ([B[B)I
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_generate_1keypair
 ...
 * Signature: ([B[B[B)I
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_encap_1secret
 ...
 * Signature: ([B[B[B)I
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_decap_1secret
...
Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_keypair_1with_1timing_1native(
        JNIEnv *env, jobject obj,
...
/*
 * Class:     io_github_oliverbajus_liboqs_android_KeyEncapsulation
 ...
 */
JNIEXPORT jlong JNICALL
Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_encaps_1with_1timing_1native(
        JNIEnv *env, jobject obj,
 ...
 */
JNIEXPORT jlong JNICALL
Java_io_github_oliverbajus_liboqs_1android_kem_KeyEncapsulation_decaps_1with_1timing_1native(
        JNIEnv *env, jobject obj,
        jbyteArray jshared_secret,
        jbyteArray jciphertext,
        jbyteArray jsecret_key)
