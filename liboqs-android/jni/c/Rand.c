 ...
 * Signature: (J)[B
 */
JNIEXPORT jbyteArray JNICALL Java_io_github_oliverbajus_liboqs_1android_utils_Rand_randombytes
 ...
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_utils_Rand_randombytes_1switch_1algorithm_1native
