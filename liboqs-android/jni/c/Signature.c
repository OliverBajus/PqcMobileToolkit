 ...
 */
JNIEXPORT void JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_create_1sig_1new
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_free_1sig
 ...
 */
JNIEXPORT jobject JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_get_1sig_1details
  (JNIEnv *env, jobject obj)
{
    jclass cls = (*env)->FindClass(env, "io/github/oliverbajus/liboqs_android/sig/Signature$SignatureDetails");
 ...
 * Signature: ([B[B)I
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_generate_1keypair
 ...
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_sign
 ...
 * Signature: ([BJ[BJ[B)Z
 */
JNIEXPORT jboolean JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_verify
 ...
 * Signature: ([BLjava/lang/Long;[BJ[B)I
 */
JNIEXPORT jint JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_sign_1with_1ctx_1str
  (JNIEnv * env, jobject obj, jbyteArray jsignature, jobject sig_len_obj,
 ...
 * Signature: ([BJ[BJ[B)Z
 */
JNIEXPORT jboolean JNICALL Java_io_github_oliverbajus_liboqs_1android_sig_Signature_verify_1with_1ctx_1str
  (JNIEnv *env, jobject obj, jbyteArray jmessage, jlong message_len,
...
Java_io_github_oliverbajus_liboqs_1android_sig_Signature_keypair_1with_1timing_1native(
        JNIEnv *env, jobject obj,
        jbyteArray jpublic_key,
        jbyteArray jsecret_key)
{
 ...
 */
JNIEXPORT jlong JNICALL
Java_io_github_oliverbajus_liboqs_1android_sig_Signature_sign_1with_1timing_1native(
        JNIEnv *env, jobject obj,
 ...
 */
JNIEXPORT jlong JNICALL
Java_io_github_oliverbajus_liboqs_1android_sig_Signature_verify_1with_1timing_1native(
        JNIEnv *env, jobject obj,
        jbyteArray jmessage,
        jbyteArray jsignature,
        jbyteArray jpublic_key)
