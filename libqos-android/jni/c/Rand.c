 ...
 * Signature: (J)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_example_libqos_1android_utils_Rand_randombytes
 ...
 */
JNIEXPORT jint JNICALL Java_com_example_libqos_1android_utils_Rand_randombytes_1switch_1algorithm_1native
